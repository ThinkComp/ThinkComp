          ...
          {promotions?.map((item) => (
            <div className="flex flex-col w-[25rem]">
              <div className="relative bg-gray-100 rounded mb-2">
                <span className="text-black/60 font-bold overflow-ellipsis">{item.link}</span>
                <div className="absolute right-0 text-green-700 top-0 text-xl cursor-pointer">
                  <i class="uil uil-edit-alt"></i>
                </div>
              </div>
              <img src={item?.url} className="w-[30rem] h-[10rem] object-contain" />
              <div className="mx-auto text-4xl text-red-700 mt-2 cursor-pointer">
                <button onClick={() => handlePromotionDelete(item._id)} disabled={posterLoading && true}>
        ...
        <div className="grid grid-cols-6 gap-12 mt-16">
          {posters?.map((item) => (
            <div className="flex flex-col">
              <div className="relative bg-gray-100 rounded mb-2 overflow-x-hidden">
                <span className="text-black/60 font-bold">{item.link}</span>
                <div className="absolute right-0 text-green-700 top-0 text-xl cursor-pointer">
                  <i class="uil uil-edit-alt"></i>
                </div>
              </div>
